...
void print_gemhitpos_perecalbin( const char* simfilename = "dummy" )
{
	...
	// 	if ( i_can == 0 ) canvas_perecalbin[i_can]->Print("test2.pdf(");
	// 	else if ( i_can == n_ecalbins - 1 ) canvas_perecalbin[i_can]->Print("test2.pdf)");
	// 	else canvas_perecalbin[i_can]->Print("test2.pdf");
